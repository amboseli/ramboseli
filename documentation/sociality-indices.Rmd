...
knitr::opts_chunk$set(
  collapse = TRUE,
  comment = "#>",
  fig.path = "plots/sociality-indices"
)
```
...
```{r prep-workspace-hidden, echo=FALSE, message=FALSE, results=FALSE, warning=FALSE}
...
<br>
__Create the SSH tunnel before proceeding!__ Instructions [here](../README.md).
<br>

### Create connection to babase and pull data into data frames in your current R environment.

```{r babase-connections, eval=FALSE}
